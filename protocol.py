...
FAMILY_SCHEMAS: Dict[str, Sequence[FieldSpec]] = {
    ...
    "E5_SINGLE_KEY": (FieldSpec("version", "u16"), FieldSpec("infrared", "u8", 2),
              FieldSpec("key", "u8"), FieldSpec("temperature", "u16")),
    "E5_DOUBLE_KEY": (FieldSpec("version", "u16"), FieldSpec("infrared", "u8", 2),
              FieldSpec("key", "u8", 2), FieldSpec("temperature", "u16")),
    "E5_THREE_KEY": (FieldSpec("version", "u16"), FieldSpec("infrared", "u8", 2),
              FieldSpec("key", "u8", 3), FieldSpec("temperature", "u16")),
    "E5_FOUR_KEY": (FieldSpec("version", "u16"), FieldSpec("infrared", "u8", 2),
              FieldSpec("key", "u8", 4), FieldSpec("touch", "u8"),
              FieldSpec("temperature", "u16")),
    "H3_SINGLE_KEY": (FieldSpec("version", "u16"), FieldSpec("infrared", "u8", 2),
              FieldSpec("key", "u8")),
    "H3_DOUBLE_KEY": (FieldSpec("version", "u16"), FieldSpec("infrared", "u8", 2),
              FieldSpec("key", "u8", 2)),
    "H3_THREE_KEY": (FieldSpec("version", "u16"), FieldSpec("infrared", "u8", 2),
              FieldSpec("key", "u8", 3)),
    "E7D": (FieldSpec("version", "u16"), FieldSpec("temperature", "u8"),
    ...
    "CE1": (FieldSpec("version", "u8"), FieldSpec("rx_rssi", "s8"),
             FieldSpec("illuminance", "u16", 2), FieldSpec("key", "u8", 2),
             FieldSpec("speed", "u8", 2)),
...
def build_config_command(sequence: int, product: Mapping[str, Any],
    ...
    encoded = payload_hex(
        str(product.get("schema_name", product["family"])), product["fields"],
